...
data1 = np.loadtxt('nrp401.txt', dtype='int')  # sequence of requirements
data1 = np.array(data1)
data11 = data1[:, 0]
data12 = data1[:, 1]
data1 = np.r_[data11, data12]                  # combine requirements A & B, we take them the same

data2 = np.loadtxt('nrp402.txt', dtype='int')  # cost of requirements
